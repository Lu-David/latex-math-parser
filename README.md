...
* Adding unit tests for operators and basic functions
* Bignumber MathJS configuration for high precision calculation
* Support for evaluating LaTex generated by MathQuill

Link to original TeX Math Parser repo: https://github.com/davidtranhq/tex-math-parser 
